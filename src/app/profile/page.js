...
export default function ProfilePage() {
  ...
  const availableTags = [
    "Crypto", "Politics", "Sports", "Technology", "Finance", "Economics",
    "AI/ML", "Climate", "Gaming", "Entertainment", "Health", "Science",
    "Real Estate", "Stocks", "Commodities", "Elections", "World Events"
  ];
  ...
  const achievements = [
    { title: "Early Adopter", description: "Joined in the first quarter", icon: IconAward, color: "text-blue-500" },
    { title: "Accuracy Expert", description: "Maintained 85%+ accuracy", icon: IconTarget, color: "text-green-500" },
    { title: "Volume Trader", description: "Traded over $200K volume", icon: IconChartBar, color: "text-purple-500" },
    { title: "Market Leader", description: "Top 100 on leaderboard", icon: IconStar, color: "text-yellow-500" }
  ];
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-neutral-600 dark:text-neutral-400">Accuracy Rate</span>
                  <span className="font-semibold text-green-500">{userData.accuracy}%</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-neutral-600 dark:text-neutral-400">Total Volume</span>
                  <span className="font-semibold">${userData.totalVolume.toLocaleString()}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-neutral-600 dark:text-neutral-400">Active Positions</span>
                  <span className="font-semibold text-blue-500">{userData.activePositions}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-neutral-600 dark:text-neutral-400">Total Trades</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <Card className="bg-gradient-to-r from-green-500 to-green-600 text-white border-0">
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-green-100 text-xs font-medium">Total P&L</p>
                          <p className="text-2xl font-bold">+$4,520</p>
                          <p className="text-green-200 text-xs">+18.5% this month</p>
                        </div>
                  ...
                  <Card className="bg-gradient-to-r from-purple-500 to-purple-600 text-white border-0">
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-purple-100 text-xs font-medium">Avg Trade</p>
                          <p className="text-2xl font-bold">$1,245</p>
                          <p className="text-purple-200 text-xs">Risk managed</p>
                        </div>
                  ...
                  <Card className="bg-gradient-to-r from-orange-500 to-orange-600 text-white border-0">
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-orange-100 text-xs font-medium">Streak</p>
                          <p className="text-2xl font-bold">7 wins</p>
                          <p className="text-orange-200 text-xs">Current streak</p>
                        </div>
            ...
            {activeTab === "trades" && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Your recent prediction market trades</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    {recentTrades.map((trade) => (
                      <div key={trade.id} className="flex items-center justify-between p-4 bg-neutral-50 dark:bg-neutral-800 rounded-lg">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-4 text-sm text-neutral-500 dark:text-neutral-400">
                            <span className={cn(
                              ...
                              trade.position === "YES" ? "bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200" : "bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200"
                            )}>
                              {trade.position}
                            </span>
              ...
              <div className="space-y-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Help us personalize your NooRooFi experience by telling us about your preferences
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-8">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4">
                        How would you describe your risk tolerance when trading on prediction markets?
                      </p>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4">
                        Select your primary use case to help us tailor the experience:
                      </p>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {usageIntents.map((intent) => (
                          <button
                            key={intent.value}
                            onClick={() => handleUsageIntentChange(intent.value)}
                            className={cn(
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Overview of your selected preferences</CardDescription>
                  </CardHeader>
                  <CardContent>
                      ...
                      <div>
                        ...
                        <span className="text-sm text-neutral-600 dark:text-neutral-400">
                          {surveyData.riskProfile ? 
                            riskProfiles.find(p => p.value === surveyData.riskProfile)?.label :
                            "Not selected"
                          }
                        </span>
                      </div>
                      <div>
                        ...
                        <span className="text-sm text-neutral-600 dark:text-neutral-400">
                          {surveyData.usageIntent ? 
                            usageIntents.find(i => i.value === surveyData.usageIntent)?.label :
                            "Not selected"
                          }
                        </span>
                      </div>
              ...
              <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <div className="mt-1 flex items-center space-x-2">
                          <span className="text-neutral-900 dark:text-neutral-100">{userData.name}</span>
                      ...
                      <div>
                        ...
                        <div className="mt-1 flex items-center space-x-2">
                          <span className="text-neutral-900 dark:text-neutral-100">{userData.email}</span>
                          <IconEdit className="h-4 w-4 text-neutral-400 cursor-pointer hover:text-neutral-600" />
                        </div>
                      </div>
                      <div>
                        ...
                        <div className="mt-1 flex items-center space-x-2">
                          <span className="text-neutral-900 dark:text-neutral-100">{userData.phone}</span>
                          <IconEdit className="h-4 w-4 text-neutral-400 cursor-pointer hover:text-neutral-600" />
                        </div>
                      </div>
                      <div>
                        ...
                        <div className="mt-1 flex items-center space-x-2">
                          <span className="text-neutral-900 dark:text-neutral-100">{userData.location}</span>
                          <IconEdit className="h-4 w-4 text-neutral-400 cursor-pointer hover:text-neutral-600" />
                        </div>
                      </div>
                    </div>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <h4 className="font-medium text-neutral-900 dark:text-neutral-100">Email Notifications</h4>
                        <p className="text-sm text-neutral-500 dark:text-neutral-400">Receive updates about your trades</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <h4 className="font-medium text-neutral-900 dark:text-neutral-100">Two-Factor Authentication</h4>
                        <p className="text-sm text-neutral-500 dark:text-neutral-400">Secure your account with 2FA</p>
                      </div>
                      <Button variant="outline" size="sm">
                        Enable
                      </Button>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <h4 className="font-medium text-neutral-900 dark:text-neutral-100">API Access</h4>
                        <p className="text-sm text-neutral-500 dark:text-neutral-400">Manage your API keys</p>
                      </div>
                      <Button variant="outline" size="sm">
                        Manage
                      </Button>
