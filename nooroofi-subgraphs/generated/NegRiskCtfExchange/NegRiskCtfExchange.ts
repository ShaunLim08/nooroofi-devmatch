...
export class NegRiskCtfExchange__getOrderStatusResultValue0Struct extends ethereum.Tuple {
...
export class NegRiskCtfExchange__hashOrderInputOrderStruct extends ethereum.Tuple {
  get salt(): BigInt {
...
export class NegRiskCtfExchange__orderStatusResult {
  value0: boolean;
  value1: BigInt;
...
export class NegRiskCtfExchange__registryResult {
  value0: BigInt;
  value1: Bytes;
...
export class NegRiskCtfExchange extends ethereum.SmartContract {
  static bind(address: Address): NegRiskCtfExchange {
    return new NegRiskCtfExchange("NegRiskCtfExchange", address);
  }
  ...
  getOrderStatus(
    orderHash: Bytes,
  ): NegRiskCtfExchange__getOrderStatusResultValue0Struct {
    let result = super.call(
      "getOrderStatus",
    ...
    return changetype<NegRiskCtfExchange__getOrderStatusResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getOrderStatus(
    orderHash: Bytes,
  ): ethereum.CallResult<NegRiskCtfExchange__getOrderStatusResultValue0Struct> {
    let result = super.tryCall(
      "getOrderStatus",
      "getOrderStatus(bytes32):((bool,uint256))",
      [ethereum.Value.fromFixedBytes(orderHash)],
    ...
    return ethereum.CallResult.fromValue(
      changetype<NegRiskCtfExchange__getOrderStatusResultValue0Struct>(
        value[0].toTuple(),
      ),
    );
  }
  ...
  hashOrder(order: NegRiskCtfExchange__hashOrderInputOrderStruct): Bytes {
    let result = super.call(
      "hashOrder",
  ...
  try_hashOrder(
    order: NegRiskCtfExchange__hashOrderInputOrderStruct,
  ...
  orderStatus(param0: Bytes): NegRiskCtfExchange__orderStatusResult {
    let result = super.call(
      "orderStatus",
    ...
    return new NegRiskCtfExchange__orderStatusResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
    );
  }
  ...
  try_orderStatus(
    param0: Bytes,
  ): ethereum.CallResult<NegRiskCtfExchange__orderStatusResult> {
    let result = super.tryCall(
      "orderStatus",
      "orderStatus(bytes32):(bool,uint256)",
      [ethereum.Value.fromFixedBytes(param0)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new NegRiskCtfExchange__orderStatusResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
      ),
    );
  ...
  registry(param0: BigInt): NegRiskCtfExchange__registryResult {
    let result = super.call("registry", "registry(uint256):(uint256,bytes32)", [
      ethereum.Value.fromUnsignedBigInt(param0),
    ]);

    return new NegRiskCtfExchange__registryResult(
      result[0].toBigInt(),
      result[1].toBytes(),
    );
  }
  ...
  try_registry(
    param0: BigInt,
  ): ethereum.CallResult<NegRiskCtfExchange__registryResult> {
    let result = super.tryCall(
      "registry",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new NegRiskCtfExchange__registryResult(
        value[0].toBigInt(),
        value[1].toBytes(),
      ),
    );
